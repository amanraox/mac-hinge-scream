...
if it doesn't work synchronously then,
...
> ```
> Now close the terminal and act completely innocent. To stop it later: `pkill -f hinge.py`
...
| Poll interval | 50ms |
| Sound gap | 300ms |
| Reaction time | ~50ms (1 poll) |
| Volume range | 50%–200% of source |
| Playback rate | 0.8x–1.6x |
| play_sound latency | ~2.4ms |
| stop_sound latency | ~4ms |
